...
(deftest test-annotation-patch
  (testing "annotation fields one at a time"
    (let [new_annotation (g/get_random_annotation_without_id (:id test-coll-one) (:id test-cont-one))
      ...
      (doseq [val (seq (dissoc new_annotation :content-id :collection-id))]
             [(do
  ...
  (testing "annotation multiple fields at once"
    (let [new_annotation (g/get_random_annotation_without_id (:id test-coll-two) (:id test-cont-two))
    ...
    (testing "annotation all fields at once"
      (let [new_annotation (g/get_random_annotation_without_id (:id test-coll-thr) (:id test-cont-thr))
